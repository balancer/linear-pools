...
const BaseVersion = { version: 1, deployment: '20230112-reaper-rebalanced-linear-pool' };
...
export default {
  ...
  WETH,
  FactoryVersion: JSON.stringify({ name: 'ReaperLinearPoolFactory', ...BaseVersion }),
  PoolVersion: JSON.stringify({ name: 'ReaperLinearPool', ...BaseVersion }),
