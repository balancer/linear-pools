...
import logger from './task-libraries/logger';
import Verifier from './task-libraries/verifier';
import { deploy, deploymentTxData, instanceAt } from './task-libraries/contracts';
...
export default class Task {
  ...
  dir(): string {
    ...
    const nonDeprecatedDir = this._dirAt(TESTS_DIRECTORY, this.id, false);
