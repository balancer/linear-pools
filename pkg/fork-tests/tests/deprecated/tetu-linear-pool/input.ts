...
const BaseVersion = { version: 1, deployment: 'tetu-linear-pool' };
...
export default {
  ...
  WETH,
  FactoryVersion: JSON.stringify({ name: 'TetuLinearPoolFactory', ...BaseVersion }),
  PoolVersion: JSON.stringify({ name: 'TetuLinearPool', ...BaseVersion }),
