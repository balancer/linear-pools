...
describeForkTest('polygon - MidasLinearPoolFactory - 4 decimals', 'polygon', 40164926, function () {
  ...
  before('run task', async () => {
    task = new Task('20230310-midas-rebalanced-linear-pool', TaskMode.TEST, getForkedNetwork(hre));
  ...
  describe('create and check getters', () => {
    ...
    it('check factory version', async () => {
      const expectedFactoryVersion = {
        ...
        version: 1,
        deployment: '20230310-midas-rebalanced-linear-pool',
      };
